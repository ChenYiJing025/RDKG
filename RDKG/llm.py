...
async def ollama_model1_complete(
    prompt, system_prompt=None, history_messages=[], **kwargs
) -> str:
    model_name1 = kwargs["hashing_kv"].global_config["llm_model_name1"]
...
async def ollama_model2_complete(
    prompt, system_prompt=None, history_messages=[], **kwargs
) -> str:
    model_name2 = kwargs["hashing_kv"].global_config["llm_model_name2"]
    return await ollama_model_if_cache(
        model_name2,
        prompt,
        system_prompt=system_prompt,
...
async def ollama_model3_complete(
    prompt, system_prompt=None, history_messages=[], **kwargs
) -> str:
    model_name3 = kwargs["hashing_kv"].global_config["llm_model_name3"]
    return await ollama_model_if_cache(
        model_name3,
        prompt,
        system_prompt=system_prompt,
...
async def ollama_model4_complete(
    prompt, system_prompt=None, history_messages=[], **kwargs
) -> str:
    model_name3 = kwargs["hashing_kv"].global_config["llm_model_name3"]
    return await ollama_model_if_cache(
